...
export default function Page() {
  ...
  return (
    <div className="select-none flex min-h-screen items-center justify-center bg-[#e5e5e5] p-4 transition-colors duration-300 dark:bg-gray-900">
      <div
      ...
      >
        <div className="grid grid-cols-3 gap-3 xs:grid-cols-4 sm:grid-cols-4 sm:gap-4 md:grid-cols-6 lg:grid-cols-8">
          ...
          <div
            ...
            className="group aspect-square rounded-full bg-white p-2 transition-all duration-300 hover:bg-gray-100 hover:shadow-lg dark:bg-gray-800 dark:hover:bg-gray-700 sm:p-4 cursor-pointer"
          >
          ...
          <div className="group aspect-square rounded-full bg-white transition-all hover:scale-110 dark:bg-gray-800">
            <Link
          ...
          <div className="group p-4 col-span-3 aspect-[3/3] rounded-3xl bg-white transition-all duration-300 hover:scale-105 dark:bg-gray-800 xs:col-span-4 xs:aspect-[2/1] sm:col-span-2 sm:row-span-2 sm:aspect-square sm:p-4">
            <div className="relative h-full w-full cursor-cell">
              <Image
                ...
                fill
                className="object-contain rounded-xl transition-opacity duration-300 group-hover:opacity-90"
              />
              <div className="absolute bottom-0 left-0 p-2 sm:p-4">
                <h3 className="text-xs text-white font-medium transition-colors duration-300 group-hover:text-indigo-300 dark:text-white dark:group-hover:text-indigo-400 sm:text-sm">
                  neroices...
                </h3>
                <p className="text-[10px] text-gray-400 transition-colors duration-300 group-hover:text-indigo-400 dark:text-gray-400 dark:group-hover:text-indigo-300 sm:text-xs">
                  ねろ
                </p>
              </div>
            </div>
          ...
          <div className="relative aspect-square rounded-full bg-white transition-all duration-300 hover:scale-105 dark:bg-gray-800 overflow-hidden">
          ...
          <div className="group aspect-square rounded-full bg-white p-2 transition-all duration-300 hover:scale-110 dark:bg-gray-800 sm:p-4">
            <Link
          ...
          <div className="group aspect-square bg-white rounded-3xl transition-all duration-300 hover:shadow-lg dark:bg-gray-800 hover:scale-105">
          ...
          <div className="group aspect-square rounded-full bg-black text-white hover:text-black hover:bg-white p-2 transition-all duration-300 hover:shadow-lg dark:bg-white dark:hover:bg-gray-800 dark:hover:text-white dark:text-black sm:p-4">
            <Link
              href="https://slce.moe"
              target="_blank"
              rel="noopener noreferrer"
          ...
          <div className="col-span-3 md:w-50 sm:w-50 aspect-[4/1] rounded-full bg-black p-5 transition-all duration-300 hover:bg-gray-800 hover:shadow-lg  dark:hover:bg-gray-300 sm:p-4 xs:aspect-[3/1] dark:bg-white">
          ...
          <div className="group col-span-2 aspect-[2/1] rounded-3xl bg-white dark:bg-gray-800 hover:scale-105 transition-all duration-300 hover:bg-gray-900 hover:shadow-lg dark:hover:bg-gray-700 flex items-center justify-center">
            <div className="relative h-full w-full cursor-cell">
              <Image
                src="/img/kazu.png"
                alt="neroices"
          ...
          <div className="grid aspect-square grid-cols-2 gap-1">
            {[
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group flex aspect-square items-center justify-center rounded-xl bg-[#d1d1d1] transition-all duration-300 hover:bg-gray-300 dark:bg-gray-700 dark:hover:bg-gray-600"
              >
          ...
          <div className="col-span-3 aspect-[2/1] rounded-3xl bg-white p-4 transition-all duration-300 hover:shadow-lg dark:bg-gray-800 dark:text-white xs:col-span-2 xs:row-span-2 xs:aspect-square sm:col-span-2">
          ...
          <div className="group aspect-square rounded-full bg-white p-2 transition-all duration-300 hover:shadow-lg dark:bg-gray-800 sm:p-4">
            <Link
